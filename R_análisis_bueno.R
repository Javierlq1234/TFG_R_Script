...
# 3. BLOQUEO con asignación equilibrada
...
#-------------------------------------
# LIMPIAR DATOS (eliminar expertos)
#-------------------------------------
...
#-------------------------------------
# ESTADÍSTICOS DESCRIPTIVOS (con IQR)
#-------------------------------------
...
variables_ttest <- c(
  "NASA_total", "demanda_mental", "demanda_temporal",
  "esfuerzo", "frustracion", "rendimiento",
  "calidad_texto", "n_temas"
)
...
for (var in variables_ttest) {
  ...
  resultados_t[[var]] <- list(t_test = t_test, cohen_d = d)
}
